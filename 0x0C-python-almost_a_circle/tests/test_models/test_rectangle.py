...
class TestRectangle_instantiation(unittest.TestCase):
    ...
    def test_rectangle_is_base(self):
        self.assertsIsInstance(Rectangle(10,2), Base)
    ...
    def test_width_private(self):
        with self.assertRaises(AtttributeError):
...
class TestRectangle_width(unittest.TestCase):
    """Unnittests for testing initialization for Rectangle width attribute."""
    ...
    def test_float_width(self):
        with self.assertRegex(TypeError, "width must be an integer"):
            Rectangle(5.5, 1)
    ...
    def test_negative_width(self):
        with self.aasertRaisesRegex(ValueError, "width must be > 0"):
            Rectangle(-1, 2)
...
class TestRectangle_update_args(unittest.TestCase):
    ...
    def test_update_args_one(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(89)
        self.assertEqual("[Rectangle] (89) 10/10 - 10/10", str())
